...
export default function BoekingLandingPage() {
  ...
  className="bg-green-500 hover:bg-green-400 text-black font-semibold px-7 py-4 rounded-2xl text-lg transition shadow-xl shadow-green-500/20 text-center flex items-center gap-2 justify-center"
>
          ...
          {[
            {
              ...
              price: 'R599',
              featured: false,
              features: ['1 restaurant', 'Up to 200 bookings/month', 'WhatsApp AI booking bot', 'Waiting list management', '24hr reminders', 'Basic dashboard'],
            ...
            },
            {
              ...
              price: 'R999',
              featured: true,
              features: ['1 restaurant', 'Unlimited bookings', 'WhatsApp AI booking bot', 'Waiting list management', '24hr + 2hr reminders', 'Full staff dashboard', 'Customer history and no-show tracking', 'Custom greeting + branding'],
            ...
            },
            {
              ...
              price: 'Custom',
              featured: false,
              features: ['Up to 5 locations', 'Unlimited bookings', 'WhatsApp AI booking bot', 'Waiting list management', 'Custom reminder schedule', 'Multi-location dashboard', 'Customer history and no-show tracking', 'Custom branding', 'Dedicated account manager'],
              missing: [],
            },
          ].map((plan) => (
            <div
